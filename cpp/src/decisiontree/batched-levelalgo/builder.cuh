...
struct Builder {
  ...
  static constexpr bool kIsClassifier =
    std::is_same<typename ObjectiveT::BinT, CountBin>::value;
  static constexpr bool kIsRegressor =
    std::is_same<typename ObjectiveT::BinT, AggregateBin>::value;
